...
│   ├── api/  ← (22 files) FastAPI routes (local + cloud), 120+ endpoints
│   │   ├── cloud_routes/  ← (6 files) Render cloud API routes (6 files)
│   │   ├── routes/  ← (13 files) Local API routes (14 files)
│   │   ├── __init__.py
│   │   ├── app.py
│   │   ├── cloud_app.py
│   │   └── websocket.py
...
│   │   ├── rate_limiter.py
│   │   └── value_tracker.py
│   ├── data_collection/  ← (16 files) 12 overnight collectors (options, VIX, FRED, EDGAR, etc.)
│   │   ├── __init__.py
