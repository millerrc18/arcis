...
def test_recap_service_shadow_data_failure_logs_warning(caplog):
    """recap_service.py:57 — get_shadow_data_for_recap() failure must log WARNING not pass silently."""
...
def test_shadow_service_account_info_failure_logs_warning(caplog):
    """shadow_service.py:98 — get_account_info() failure must log WARNING not pass silently."""
...
def test_system_service_get_live_broker_failure_logs_warning(caplog):
    """system_service.py:175 — get_live_broker() failure must log WARNING not pass silently."""
