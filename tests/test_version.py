...
Verifies:
- src.version.VERSION is bumped to v0.36.11
- src.api.app.app.version equals bare semver 0.36.11 (derived from VERSION)
- src.api.cloud_app.app.version equals bare semver 0.36.11 (derived from VERSION)
"""
import os
...
def test_cloud_app_version_is_bare_semver():
    from src.api.cloud_app import app as cloud_app
    assert cloud_app.version == "0.36.11"
