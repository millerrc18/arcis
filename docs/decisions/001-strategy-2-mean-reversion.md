...
**Date:** 2026-03-28
**Status:** Active
**Context:** Halcyon Lab needed a second strategy that could diversify the live pullback desk instead of duplicating its risk. The research pass compared breakout, mean reversion, and earnings-driven alternatives through the lens of correlation, trade frequency, and implementation simplicity.
