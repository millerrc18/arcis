...
**Decision:** Arcis uses equal-weight / 1-N style risk budgeting until roughly 200 trades or equivalent evidence exists to justify more complex allocation. Optimizers stay out of the critical path before then.
