...
**Date:** 2026-03-28
**Status:** Active
**Context:** The reinforcement-learning stage needed a method that was both research-supported and realistically available in the Halcyon Lab training stack. Pure GRPO looked weak on small prompt datasets, while the most attractive academic variants were not all production-ready.
