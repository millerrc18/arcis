...
**Date:** 2026-03-28
**Status:** Active
**Context:** Arcis needed regime awareness early, but the first implementation had to resist overfitting and stay explainable during Bootcamp. More advanced HMM-style detection remained attractive, but not as a first production step.
