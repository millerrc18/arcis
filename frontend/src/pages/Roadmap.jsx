    ...
    { id: 'p1', name: 'Phase 1 — Bootcamp (Diagnostic)', status: 'active', capital: '$100K paper + $100 live', cost: '$64/mo', timeline: 'Apr 2026 – (extended per SD#41 REVISED)',
      ...
      subphases: [
        ...
        { label: 'Weeks 8–12: Risk & NLP', items: [
          ...
          { l: 'Grafana Cloud observability MVP (SD#40)', s: 'pending', c: 'ops', d: 'Centralized log aggregation via Grafana Cloud Loki (free tier, $0/mo). Async Python handler ships all logger output. 4-panel dashboard: log stream, error rate, trade events, watch loop health. Eliminates copy-paste debugging with AI agents.', r: 'Spec: sprint-grafana-observability-mvp.md — Ralph-looped 3x' },
        ...
        { label: 'Parked / deferred', items: [
          ...
          { l: 'Refactor executor.py mega-functions (618/565/387 lines)', s: 'pending', c: 'ops', d: 'Three functions in src/shadow_trading/executor.py exceed 60-line limit: check_and_manage_open_trades=618, open_shadow_trade=565, open_live_trade=387. Split into scoped helpers. Severity: critical.', r: 'Issue #479' },
          ...
          { l: 'v0.24.1 scheduled-kind find_candidates_for_date wiring', s: 'pending', c: 'strategy', d: 'Platform spec Task 4 completion. Wires scheduled strategies into the candidate resolver. src/platform/signal_eval.py:180 currently raises NotImplementedError.', r: 'Issue #494' },
          { l: 'v0.24.1 python_plugin execution wiring', s: 'pending', c: 'strategy', d: 'Platform spec Task 2 completion. Wires Python plugin strategies alongside YAML-declarative. src/platform/signal_eval.py:188 currently raises NotImplementedError.', r: 'Issue #493' },
