    ...
    { id: 'p1', name: 'Phase 1 — Bootcamp', status: 'active', capital: '$100K paper + $100 live', cost: '$64/mo', timeline: 'Apr–Jun 2026',
      ...
      subphases: [
        ...
        { label: 'Weeks 8–12: Risk & NLP', items: [
          ...
          { l: 'Paper-trade mean reversion (Strategy #2)', s: 'done', c: 'strategy', d: 'Connors RSI(2) mean reversion on S&P 100. Feature engine, executor, position monitor integrated.', r: 'Deep Research: moved from Phase 2 to Phase 1' },
          ...
          { l: 'Stress test suite (2008/2020/2022)', s: 'done', c: 'validation', d: 'Walk-forward backtest through GFC, COVID crash, and 2022 bear market. Dashboard page + API endpoint.', r: 'Deep Research: Phase 1→2 gate addition' },
          { l: '4-tier multi-cadence scanning', s: 'done', c: 'strategy', d: '15min position monitoring, 30min price alerts, 60min sentiment updates, daily fundamental refresh. Modules extracted from watch.py.', r: 'Deep Research: scanning intervals study' },
