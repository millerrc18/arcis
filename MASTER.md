...
| Metric | Value |
|---|---|
| Phase | 1 (Honest Baseline, post-2026-04-27 audit) -- bootcamp paper archived, $100 live deploy gated by `scripts/preflight_monday.py`. **3-stage roadmap (audit-spec §3.1):** Stage 1 = honest signed baseline (DONE 2026-04-25, commit `d651160`); Stage 2 = excess Sharpe ≥ 0.5 over 150 OOS trades; Stage 3 = > 1.0 over 300 OOS. SD#41 REVISED's raw-Sharpe gate superseded. |
