...
- **Test count must not drop** — CI enforces a minimum of 3159 tests (post-Track-1 Integrator sweep baseline as of 2026-04-25; +121 net from prior 3038 floor across 6 Track 1 commits: T1.01 +12, T1.06 +9, T1.03 +19, T1.08 +31, T1.07 +30, T1.02 +19, +1 transitive). Pre-existing failure: tests/test_repo_structure.py::test_no_function_over_60_lines (place_live_bracket from #651, unchanged). Bump this number in CLAUDE.md whenever the sweep grows past the previous baseline.
