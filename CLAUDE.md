...
- **Test count must not drop** — CI enforces a minimum of 2897 tests (current sweep baseline as of 2026-04-24, PR #639). Bump this number in CLAUDE.md whenever the sweep grows past the previous baseline.
