<!-- Counts verified 2026-03-31: 170 Python files, 85 test files, 1168 tests, 53 CLI commands, 124 API routes, 40 DB tables (active SQLite schema), 67 research docs. -->
