...
def get_preflight_latest() -> dict:
    ...
    Scans audits/ for the newest preflight_transcript.txt and returns the
    empty-state dict when no transcript has been written yet, so the dashboard
    can render its 'Preflight has not been run yet' message.
    """
